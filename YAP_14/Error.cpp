...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY_NODEF(113,"При создании превышен максимальный размер таблицы лексем"), ERROR_ENTRY_NODEF(114,"Превышен максимальный размер в таблице лексем при добавлении"),ERROR_ENTRY_NODEF(115),
